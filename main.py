...
async def generate_presentation_v2(
    ...
    """
    Pipeline V3 — layouts pré-testés, charte fidèle, zéro génération de code.
    ...
    try:
        ...
        log.error(f'[V3] Erreur pipeline, fallback L1 : {e}', exc_info=True)
        final_bytes, plan, brand = run_pipeline(pptx_bytes, prompt, n)
